...
Description: Add post types for Test Purpouses
Author: Pedro Henrique Cagol
*/
...
function Create_CPT() {
	...
	$args = array(
		...
		'description'           => __( 'My cpt', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'revisions' ),
		'taxonomies'            => array( 'cpt-category', 'cpt-tag' ),
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
	...
	register_post_type( 'customtypeposts', $args );
